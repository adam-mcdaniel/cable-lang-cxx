...
Value l = __CABLELANG__PARAMS__[Value(0)]; Value u = __CABLELANG__PARAMS__[Value(1)]; Value result = Value(Value(L({})));	Value n = l;	while ((n < u).to_bool()) {n = n+Value(1);
result = result+Value(Value(L({n})));};	return result;}));
